...
class ChatGLMForConditionalGeneration(ChatGLMPreTrainedModel):
    ...
    @torch.no_grad()
    def chat(self, tokenizer, query: str, history: List[Tuple[str, str]] = None, max_length: int = 3500, num_beams=1,
             do_sample=True, top_p=0.7, temperature=0.75, logits_processor=None, **kwargs):
        if history is None:
            history = []
